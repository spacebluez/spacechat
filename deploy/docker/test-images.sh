...
docker build --build-arg SPACECHAT_BASE_IMAGE_PREFIX --build-arg GOPROXY --build-arg DEBIAN_MIRROR --build-arg WINDOWS_TERMINAL_URL --target artifacts -t "$artifacts_image" .
